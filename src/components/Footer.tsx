        ...
        <div className="py-24 px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 bg-gray-100 text-sm mt-24">
            ...
            <div className="flex flex-col md:flex-row justify-between gap-24">
                ...
                <div className="hidden lg:flex justify-between w-1/2">
                    ...
                    <div className="flex flex-col justify-between"> <h1 className="font-medium text-lg">SHOP</h1> <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col justify-between"> <h1 className="font-medium text-lg">HELP</h1> <div className="flex flex-col gap-6">
