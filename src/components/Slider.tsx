...
const slides = [
    {
        ...
        url: "/",
        bg: "bd-gradient-to-r from-yellow-50 to-pink-50",
    },
    {
        id: 2,
        ...
        url: "/",
        bg: "bd-gradient-to-r from-pink-50 to-blue-50",
    },
    {
        id: 3,
        ...
        url: "/",
        bg: "bd-gradient-to-r from-blue-50 to-yellow-50",
    },
]
                ...
                {slides.map((slide) => (
                    <div className={`${slide.bg} w-screen h-full flex flex-col gap-16 xl:flex-row`} key={slide.id}>
                        ...
                        <div className="h-1/2 xl:w-1/2 xl:h-full flex flex-col items-center justify-center gap-8 xl:gap-12 text-center">
                            <h2 className="text-xl xl:text-3xl 2xl:text-5xl">{slide.description}</h2>
                            <h1 className="text-5xl xl:text-6xl 2xl:text-8xl font-semibold">{slide.title}</h1>
