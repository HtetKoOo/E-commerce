    ...
    return (
        <div className="mt-12 flex justify-between">
            <div className="flex gap-6 flex-wrap">
                ...
                <select name="all-filter" id="" className="py-2 px-4 rounded-2xl text-xs font-medium bg-[#EBEDED]">
            ...
            <div className="">
                <select name="sortby" id="" className="py-2 px-4 rounded-2xl text-xs font-medium bg-[#EBEDED]">
